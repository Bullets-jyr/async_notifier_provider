...
class _$ActivityImpl with DiagnosticableTreeMixin implements _Activity {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Activity(activity: $activity, availability: $availability, type: $type, participants: $participants, price: $price, accessibility: $accessibility, kidFriendly: $kidFriendly, duration: $duration, link: $link, key: $key)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, activity, availability, type,
      participants, price, accessibility, kidFriendly, duration, link, key);
